...
my $timestring = "RESULTS/REPK_" . "$year$mon$day-$hour$min-$rand_hex";  #;" . int(rand(1000));
...
system("/opt/local/bin/perl /usr/local/bin/prettymatrix3.pl /Library/Webserver/Documents/cgi/repk/$matrixfile > /Library/Webserver/Documents/cgi/repk/$matrixfig");
...
print INDEX "<tr><td><font color=red>WARNING</font></td><td>There are $matrixFound pairwise group combinations that cannot be differentiated by any enzymes.  Please go back and amend your groups, or increase the <i>Max Missing Group Combinations</i> optio


n to at least $matrixFound.  Examine <a href=\"enztable.html\">enztable.html</a> to identify the undifferentiated groups</td></tr>\n";
}
...
print <<EOF ;
<html><head>
<META HTTP-EQUIV="Refresh" CONTENT="0; URL=/cgi/repk/$timestring/results.html">
</head><body>
<h1>PLEASE WAIT</h1>
</body></html>
EOF
# <h3>Here, enjoy some amusement while you're just sitting there...but<br>
# OPEN IN A NEW TAB OR NEW WINDOW<br>
...
<font size=+1>
These files are accessible for at least 48 hours at <a href="/cgi/repk/$timestring/results.html">this URL</a>
EOF
}
